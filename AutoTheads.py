...
\033██░█░█░██░███░██░▀▀░██░▄▄▄██░▀▀▄██░█░█░██░███   
\033██░██▄░██░▀▀▀░██░█████░▀▀▀██░██░██░███░██░▀▀█   
\033Ai cần mua KEYVIP thì IB Tele
\n
Tool By: HONG DANH                         Phiên Bản: V1     
\033════════════════════════════════════════════════  
        \033 Telegram\033 : https://t.me/nopermcc
\033════════════════════════════════════════════════
...
token = t.read()
if author == "":
  author = input(Colorate.Diagonal(Colors.red_to_white," 💸 NHẬP AUTHORIZATION GOLIKE : "))
  ...
  if select == "2":
    ...
    os.system('cls' if os.name== 'nt' else 'clear')
    print(banner)
    author = input("\033[Nhập Auth Golike Mới : ")
    token = input("\033[Nhập T Golike Mới : ")
    Authorization = open("Authorization.txt","w")
    t = open("token.txt","w")
    Authorization.write(author)
    t.write(token)
