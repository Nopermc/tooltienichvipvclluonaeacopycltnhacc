...
\033[1;37m██░██▄░██░▀▀▀░██░█████░▀▀▀██░██░██░███░██░▀▀█
\033[1;32m\n
\033[1;97mTool By: \033[1;32mNGUYỄN HỒNG DANH            \033[1;97mPhiên Bản: \033[1;32mV4    
\033[97m════════════════════════════════════════════════  
\033[1;97m[\033[1;91m<>\033[1;97m]\033[1;95m ZALO\033[1;31m : \033[1;36mhttps://zalo.me/0382451690
\033[1;97m[\033[1;91m<>\033[1;97m]\033[1;93m YOUTUBE\033[1;31m : \033[1;32mNOPERMC
\033[1;97m[\033[1;91m<>\033[1;97m]\033[1;32m ADMIN\033[1;31m : \033[1;33mHONGDANH
\033[1;97m[\033[1;91m<>\033[1;97m]\033[1;36m TELEGRAM\033[1;31m : \033[1;91mhttps://t.me/nopermcc
\033[97m════════════════════════════════════════════════  
"""
...
if os.path.exists(cookie_file):
    ...
    if twitter_cookie:
        ...
        if new_cookie:
            ...
            print("\033[1;36mTiếp tục dùng cookie cũ.")
    else:
...
while True:
    ...
    if ads_id in ads_id_da_lam:
        lap_lai_ads += 1
        print(f"\033[1;33m  Bỏ qua job trùng lặp: ads_id={ads_id} ({lap_lai_ads} lần)")

    if lap_lai_ads >= 5:
        baoloi(ads_id, nhanjob["data"]["object_id"], account_id, nhanjob["data"]["type"])
        print("\033[1;35m  Đã báo lỗi job trùng lặp quá nhiều.")
        lap_lai_ads = 0
        time.sleep(2)
        continue
    else:
    ...
    if object_id in object_id_da_lam:
        print(f"\033[1;33m  Đã follow/like object_id={object_id} trước đó. Bỏ qua.")
    ...
    try:
        ...
        for remaining_time in range(delay, -1, -1):
            ...
            print(f"\r{color}   BUASH ANG |DZAI VCL|💮 {remaining_time}s           ", end="")
            time.sleep(1)
